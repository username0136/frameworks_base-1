...
public class PropImitationHooks {
    ...
    public static void setProps(Context context) {
         ...
         * Set Pixel 8 Pro for Google for circle to search
         * Set Pixel5a for ASI and GMS device configurator
		...
		&& processName.equals(PACKAGE_WALLPAPEREFFECTS)))) {
            if (sIsTablet) {
        ...
        } else if (sSpoofGapps && (packageName.equals(PACKAGE_TURBO)
